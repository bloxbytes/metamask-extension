...
import { BannerComponent, HomeCoinBalance, HomeCoinButtons } from '../../../pages/home/home.component';
      ...
      >
        ...
        {showTokens && (
          ...
          >
            ...
            <Box className={'tokens-tab-panel'}>
              <Box marginBottom={4}>
                <HomeCoinBalance />
              </Box>
              <Box
        ...
        {showActivity && (
          <Tab
            ...
            className={popupTabClass}
          >
            <Box className={'activity-tab-panel'}>
              <BannerComponent isPopup={isPopup} />
        ...
        {showSettings && (
          <Tab
            ...
            className={popupTabClass}
          >
            <Box className={'settings-tab-panel'}>
              <BannerComponent isPopup={isPopup} />
              <Box padding={4}>
                <SettingsTab />
              </Box>
